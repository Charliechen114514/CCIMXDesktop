...
bool LEDAdapter::processByPackage(const LEDParamsPackage* package)
{
    ...
    case Modes::Blink:
    {
        const LEDParamsPackageBlink* blink = 
            dynamic_cast<const LEDParamsPackageBlink*>(package);
    ...
    case Modes::Plain:
    {
        const LEDParamsPackagePlain* plain = 
            dynamic_cast<const LEDParamsPackagePlain*>(package);
