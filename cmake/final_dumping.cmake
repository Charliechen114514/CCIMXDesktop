function(dump_searched_plugin_widget)
    if(DEFINED PLUGINWIDGET_PLUGIN_RELEASE_DIR)
        message(STATUS "CCIMXDesktop Plugin Widget install Path is set due to PLUGINWIDGET_PLUGIN_RELEASE_DIR: ${PLUGINWIDGET_PLUGIN_RELEASE_DIR}")
    else()
        message(STATUS "CCIMXDesktop Plugin Widget will not automic install due to invalid or non-set PLUGINWIDGET_PLUGIN_RELEASE_DIR")
    endif()
    message(STATUS "Following Plugin will be built in compile time!")
    foreach(sub_dir ${PLUGINWIDGET_BUILDTIME_DIR})
        message(STATUS ">>> [PLUGIN Widget] ${sub_dir}")
    endforeach()
endfunction()
...
message(STATUS "Extern app install locations:       CCIMX_EXTERNAL_APP_BASE_DIR= ${CCIMX_INSTALL_APP_BASE_DIR}")
message(STATUS "Extern app run locations:       CCIMX_EXTERNAL_APP_BASE_DIR= ${CCIMX_EXTERNAL_APP_BASE_DIR}")
message(STATUS "-----------------------------------------------------")
...
message(STATUS "About AlarmyClock: System Internal Clock")
message(STATUS "-----------------------------------------------------")
message(STATUS "Dumping the external apps: ")
message(STATUS "Communication Application Built status Due to INCLUDE_CCOMMUNICATOR_APP: ${INCLUDE_CCOMMUNICATOR_APP}")
...
message(STATUS "-----------------------------------------------------")
message(STATUS "Now we are ready to dumped the widget plugins")
dump_searched_plugin_widget()
message(STATUS "-----------------------------------------------------")
